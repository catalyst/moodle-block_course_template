...
if ($data = $mform->get_data()) {
    require_sesskey();
    //Require ability to createincategory for this context
    $category = $data->category;
    $context = context_coursecat::instance($category);
    require_capability('block/course_template:createincategory', $context);
    ...
    $fb = get_file_packer($mimetype='application/vnd.moodle.backup');
